...
하세요`
console.log(word)
// 백틱 사용 -> 줄바꿈 + 문자열 사이에 변수도 삽입가능 (python - f'string) 단, 이스케이프 문자열은 사용 불가
...
console.log(null == undefined) // 동등 비교연산자
...
console.log('A' < 'B') //영어 비교도 가능.
console.log('Z' < 'a')
console.log('가' < '나') //한글도 가능
*/
...
// 삼항 연산자
// 가장 앞의 boolean 값이 참이면 : 앞의 값이 반환되고 반대일 경우 : 뒤의 값이 반환
console.log(true ? 1 : 2) // 1
console.log(false ? 1 : 2) // 2
console.log('nyapy' ? 'nice' : 'awesome') //nice

// 삼항의 결과를 변수에 할당 할 수 있다.
